  ...
  return (
    <div className="w-80 border-r border-border bg-card/50 backdrop-blur-sm p-4 space-y-4 overflow-y-auto scrollbar-thin">
      <div className="space-y-3">
        <h3 className="font-medium text-foreground text-sm uppercase tracking-wide">Characters</h3>
      ...
      <div className="pt-4 border-t border-border space-y-3">
        <h4 className="font-medium text-foreground text-sm uppercase tracking-wide">Input Mode</h4>
        ...
        {inputMode === 'character' && (
          <div className="text-xs text-muted-foreground">
            Playing as: <span className="text-primary">{selectedCharacter || 'Select a character'}</span>
          </div>
        )}
      </div>
    </div>
