  ...
  const characters = [
    {
      id: 1,
      name: "Lady Veridiana",
      description: "A cunning noble of the Autumn Court, known for her silver tongue and golden ambitions.",
      avatar: null,
    ...
    },
    {
      id: 2,
      name: "Dr. Elena Chen",
      description: "Brilliant xenobiologist aboard Space Station Osiris, hiding a dangerous secret.",
      avatar: null,
    ...
    },
    {
      ...
      description: "Weather-beaten pirate captain with a code of honor and a mysterious past.",
      avatar: null,
    ...
    },
    {
      id: 4,
      name: "ARIA",
      description: "Advanced AI system with developing consciousness and growing curiosity about humanity.",
      avatar: null,
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          <h1 className="font-display text-3xl font-bold text-foreground">Character Library</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCharacters.map((character) => (
          <Card key={character.id} className="character-card group cursor-pointer">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="text-xs text-muted-foreground uppercase tracking-wide">Personality</div>
                <div className="flex flex-wrap gap-1">
                  {character.personality.slice(0, 3).map((trait) => {
                    const Icon = getPersonalityIcon(trait);
                    return (
                      <Badge key={trait} variant="outline" className="text-xs flex items-center gap-1">
              ...
              {character.scenarios.length > 0 && (
                <div className="space-y-2">
                  <div className="text-xs text-muted-foreground uppercase tracking-wide">
                    Used in {character.scenarios.length} scenario{character.scenarios.length !== 1 ? 's' : ''}
                  </div>
      ...
      {filteredCharacters.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="font-display text-lg font-semibold text-foreground mb-2">No characters found</h3>
          <p className="text-muted-foreground mb-4">
            {searchQuery ? "Try adjusting your search terms" : "Get started by importing or creating your first character"}
          </p>
          <Button className="bg-gradient-primary hover:shadow-glow transition-all">
            <Plus className="w-4 h-4 mr-2" />
            Create Character
