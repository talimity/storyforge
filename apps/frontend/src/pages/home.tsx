    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="text-center space-y-4 py-8">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Create immersive stories with AI-powered characters. Act as director,
          participant, or both.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Import character cards from SillyTavern or create new ones from
                scratch. Build your character library.
              </p>
              <Link to="/characters">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Design scenarios, assign characters, and set the stage for
