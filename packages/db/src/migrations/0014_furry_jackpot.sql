...
INSERT INTO `__new_scenarios`("id", "name", "description", "status", "root_turn_id", "anchor_turn_id", "settings", "metadata", "created_at", "updated_at") SELECT "id", "name", "description", "status", "root_turn_id", "anchor_turn_id", "settings", "metadata", "created_at", "updated_at" FROM `scenarios`;--> statement-breakpoint
...
CREATE TABLE `__new_turns` (
	...
	`parent_turn_id` text,
	`sibling_order` text DEFAULT '0' NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_turns`("id", "scenario_id", "chapter_id", "parent_turn_id", "sibling_order", "author_participant_id", "created_at", "updated_at") SELECT "id", "scenario_id", "chapter_id", "parent_turn_id", "sibling_order", "author_participant_id", "created_at", "updated_at" FROM `turns`;--> statement-breakpoint
